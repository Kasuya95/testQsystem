                    ...
                    <tbody>
                        ...
                        foreach ($result as $r) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="UpdateQueueForm.php?QDate=<?= $r['QDate'] ?>&Pid=<?= $r['Pid'] ?>" class="btn btn-warning btn-sm">แก้ไข</a>
                                </td>
                                <td>
                                    <a href="DeleteQueue.php?QDate=<?= $r['QDate'] ?>&QNumber=<?= $r['QNumber'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('ยืนยันการลบข้อมูล !!');">ลบ</a>
                                </td>
